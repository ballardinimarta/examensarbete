...
function Articles() {
    ...
    const [endpoint, setEndpoint] = useState('/api/articles?populate=*')
    ...
    return (
        <>
        <div className={styles.categoryButton} onClick={()=> {setDropdown(!dropdown)}}><span>Kategori <FaAngleDown/> </span> </div>
        {dropdown ? 
